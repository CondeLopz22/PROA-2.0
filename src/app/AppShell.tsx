import { Activity, BarChart3, Building2, ClipboardCheck, ClipboardList, Database, Home, LogOut, Menu, ShieldCheck, Users } from 'lucide-react'
...
const navigation = [
  ...
  { to: '/auditoria', label: 'Auditoría PROA', icon: ShieldCheck },
